...
public class Main extends Application {
    ...
    public static class Config {
    	...
    	public ServerSession serverSession() throws Exception {
    		ServerSession serverSession = new ServerSession("spring", "/vinay", "localhost", 8080);
    		serverSession.setUseWebSocket(true);
        	serverSession.addRemoteClassPackage("tet-1.client.entities");
    ...
    public void start(final Stage stage) throws Exception {		
    	...
    	applicationContext.scan("tet-1.client");
    	applicationContext.scan("tet-1.client.services");
